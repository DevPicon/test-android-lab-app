...
public class FourthActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /*public void openUsingReorderToFront(View view) {
        Intent intent = new Intent(this, SecondActivity.class);
        //intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        startActivityForResult(intent, REQUEST_CODE_REORDER_TO_FRONT);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {

        if (requestCode == REQUEST_CODE_REORDER_TO_FRONT) {
            if (resultCode == RESULT_OK) {
                textViewResult.setText(data.getStringExtra(SecondActivity.EXTRA_RESULT));
            }
        }
